...
// Because of one image, an error may occur
Promise.race(promisesImages)
  .then((img) => imagesList.appendChild(img))
  .catch((error) => imagesList.appendChild(getBrokenImage()));

// Returns the one resolved
Promise.any(promisesImages)
  .then((img) => imagesList.appendChild(img))
  .catch((error) => imagesList.appendChild(img));
